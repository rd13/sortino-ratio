 ...
 * 
 * @param  {array} return_values asset/portfolio returns
 * @param  {number} risk free-risk rate (def: 0)
 * @param  {number} target_return minimum acceptable return (def: 0)
 * @return {number}       
 *
 * @example
...
function sortino (return_values, target_return = 0) {
...
module.exports = sortino;
//# sourceMappingURL=sortino-ratio.cjs.js.map
